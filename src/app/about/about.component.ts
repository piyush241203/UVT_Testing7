...
@Component({
  ...
  template: `
    <div class="page-header">
      <h1>About</h1>
      <p class="subtitle">Experience the power of about with our modern interface.</p>
    </div>
    <div class="card-container">
      <div class="card"><h3>Our Mission</h3><p>To provide the best visual testing experience.</p></div><div class="card"><h3>The Team</h3><p>Built by passionate developers, for developers.</p></div>
    </div>
