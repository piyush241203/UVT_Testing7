...
let ContactComponent = (() => {
    ...
    <div class="card-container">
      <div class="card"><h3>Send a Message</h3><div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;"><input type="text" placeholder="Name" style="padding: 0.75rem; border-radius: 0.5rem; border: none; background: #0f172a; color: white;" /><textarea placeholder="Message" style="padding: 0.75rem; border-radius: 0.5rem; border: none; background: #0f172a; color: white; min-height: 100px;"></textarea><button class="btn">Send</button></div></div>
    </div>
