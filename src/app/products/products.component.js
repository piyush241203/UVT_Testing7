...
let ProductsComponent = (() => {
    ...
    <div class="card-container">
      <div class="card"><h3>Pro Plan</h3><div class="stat">$29/mo</div><p>Everything you need for testing.</p><button class="btn">Upgrade</button></div><div class="card"><h3>Enterprise Plan</h3><div class="stat">Contact Us</div><p>Scale without limits.</p><button class="btn">Contact Sales</button></div>
    </div>
  ...
  `]
    ...
    let _classThis;
    var ProductsComponent = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ProductsComponent = _classThis = _classDescriptor.value;
    ...
    return ProductsComponent = _classThis;
})();
