...
let ProfileComponent = (() => {
    ...
    <div class="card-container">
      <div class="card" style="text-align: center;"><div style="width: 100px; height: 100px; border-radius: 50%; background: #f43f5e; margin: 0 auto 1rem;"></div><h3>Alex Developer</h3><p>Senior Engineer</p></div><div class="card"><h3>Bio</h3><p>Passionate about UI/UX and visual regression testing.</p></div>
    </div>
