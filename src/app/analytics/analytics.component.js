...
let AnalyticsComponent = (() => {
    ...
    <div class="card-container">
      <div class="card"><h3>Page Views</h3><div class="stat">1.2M</div></div><div class="card"><h3>Bounce Rate</h3><div class="stat">42%</div></div><div class="card"><h3>Conversion</h3><div class="stat">3.8%</div></div>
    </div>
  ...
  `]
    ...
    let _classThis;
    var AnalyticsComponent = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            AnalyticsComponent = _classThis = _classDescriptor.value;
    ...
    return AnalyticsComponent = _classThis;
})();
